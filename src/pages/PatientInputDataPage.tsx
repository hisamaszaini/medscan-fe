...
// --- [Halaman Utama] Input Data Pasien ---
        ...
        <main>
          <section className="py-20 sm:py-24 px-4">
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <label className="flex items-center p-4 bg-gray-50 border-2 border-gray-200 rounded-lg cursor-pointer has-[:checked]:bg-emerald-50 has-[:checked]:border-emerald-400 transition-colors duration-300">
                          <input 
                            type="radio" 
                            name="gender" 
                            value="male" 
            ...
            <div className="max-w-4xl mx-auto mt-8 flex justify-between items-center">
              ...
              <Link to="/screening/capture" className="group flex items-center justify-center bg-gradient-to-br from-emerald-500 to-teal-600 text-white px-8 py-4 rounded-xl text-lg font-bold transform transition-transform duration-300 hover:scale-105 shadow-lg shadow-emerald-500/30">
                Lanjutkan
